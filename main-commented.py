"""
Developed as a school project in an IoT course @ Linnaeus University (LLU), Sweden.
© Copyright 2020, David Agerberg, Edvin Hellsing and Joel Klingberg, All rights reserved.
"""
